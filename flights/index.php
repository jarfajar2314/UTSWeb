...
<body class="bg-light">
    ...
    <h2 class="text-center text-dark mt-5">Flights</h2>
                ...
                <div class="carousel-item active rounded">
                    ...
                    <div class="container">
                        <div class="carousel-caption text-left">
                            ...
                            <p><a class="btn btn-lg btn-primary" href="content/air-force-one/" role="button">Book Now</a></p>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="container">
                        <div class="carousel-caption text-left">
                            ...
                            <p><a class="btn btn-lg btn-primary" href="content/flying-dutchman/" role="button">Book Now</a></p>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="container">
                        <div class="carousel-caption text-left">
                            ...
                            <p><a class="btn btn-lg btn-primary" href="content/a6m5-zero/" role="button">Book Now</a></p>
                        </div>
                    </div>
                </div>
            </div>

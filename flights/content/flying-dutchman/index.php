...
<head>
    ...
    <script src="../../../flights/script.js"></script>
    <link href="https://fonts.googleapis.com/css2?family=Rubik&display=swap" rel="stylesheet"> 
    <title>Book Flying Dutchman</title>
    <style>
        body{
            padding-top: 4.5rem;
...
<body class="bg-light" id="flying-dutchman">
    ...
    <div id="content">
        <form action="" method="post">
            <div class="mb-lg-5 mb-3" id="img">
                <img src="../../../img/flying-dutchman.jpg" alt="" class="w-100">
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active rounded">
                    <img src="../../../img/air-force-one.jpg" alt="air-force-one" class="rounded">
                    <div class="overlay"></div>
                    <div class="container">
                        <div class="carousel-caption text-left">
                            <h1 class="display-4 text-shadow">Air Force One.</h1>
                            <p>Fly like you were a president of one great nation.</p>
                            <p><a class="btn btn-lg btn-primary" href="../air-force-one/" role="button">Book Now</a></p>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="../../../img/flying-dutchman.jpg" alt="flying-dutchman" class="rounded">
                    <div class="overlay"></div>
                    <div class="container">
                        <div class="carousel-caption text-left">
                            <h1 class="display-4 text-shadow">Flying Dutchman Ship.</h1>
                            <p>Hohoho~ Now you are Flying Dutchman's crew. No one said if a "ship" actually cannot fly.</p>
                            <p><a class="btn btn-lg btn-primary" href="../flying-dutchman/" role="button">Book Now</a></p>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="../../../img/a6m5-zero.jpg" alt="a6m5-zero" class="rounded">
                    <div class="overlay"></div>
                    <div class="container">
                        <div class="carousel-caption text-left">
                            <h1 class="display-4 text-shadow">Mitsubishi A6M5 Zero.</h1>
                            <p>If you were planning doing extraordinary flight, you must ready for this Kamikaze flight. This will be your last flight, maybe..</p>
                            <p><a class="btn btn-lg btn-primary" href="../a6m5-zero/" role="button">Book Now</a></p>
                        </div>
                    </div>
                </div>
            </div>
